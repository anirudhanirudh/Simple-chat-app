...
<div class="signin-form">
    <form action="" method="post">
		...
		<div class="form-group">
			<label>Email</label>
        	<input type="text" class="form-control" placeholder="aaaa@xyz.com" name="email" autocomplete="off" required="required">
        </div>
        <div class="form-group">
...
include("include/connection.php"); 
	...
	echo "<script>alert('Your Email or your answer is Incorrect')</script>";
